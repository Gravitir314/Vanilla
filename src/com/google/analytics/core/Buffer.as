...
package com.google.analytics.core
{
    ...
    public dynamic class Buffer 
    {
        ...
        public function Buffer(_arg_1:Configuration, _arg_2:DebugConfiguration, _arg_3:Boolean=false, _arg_4:Object=null)
        {
            var _local_5:String;
            super();
            _config = _arg_1;
        ...
        public function updateUTMA(_arg_1:Number):void
        {
            if (_debug.verbose)
            {
                _debug.info((("updateUTMA( " + _arg_1) + " )"), VisualDebugMode.advanced);
            };
            if (!utma.isEmpty())
            {
        ...
        private function _onFlushStatus(_arg_1:NetStatusEvent):void
        {
        ...
        public function toLinkerParams():String
        {
            ...
            return (_local_1 + ("&__utmk=" + generateCookiesHash()));
        }
        ...
        public function update(_arg_1:String, _arg_2:*):void
        {
            if (isVolatile())
            {
                _OBJ[_arg_1] = _arg_2;
