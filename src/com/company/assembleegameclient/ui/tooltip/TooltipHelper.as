...
package com.company.assembleegameclient.ui.tooltip
{
    public class TooltipHelper 
    {
        ...
        {
            return (wrapInFontTag(getPlural(_arg_1, _arg_3), ("#" + getTextColor(((_arg_4) ? (_arg_1 - _arg_2) : (_arg_2 - _arg_1))).toString(16))));
        }

        public static function compare(_arg_1:Number, _arg_2:Number, _arg_3:Boolean=true, _arg_4:String="", _arg_5:Boolean=false):String
        {
            return (wrapInFontTag((((_arg_5) ? Math.abs(_arg_1) : _arg_1) + _arg_4), ("#" + getTextColor(((_arg_3) ? (_arg_1 - _arg_2) : (_arg_2 - _arg_1))).toString(16))));
        }
