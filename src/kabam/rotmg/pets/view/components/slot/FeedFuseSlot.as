...
//kabam.rotmg.pets.view.components.slot.FeedFuseSlot
...
public class FeedFuseSlot extends Sprite 
    {
        ...
        protected var innerSlot:Shape = PetsViewAssetFactory.returnPetSlotShape(40, 0x545454, 3, false, true);
        protected var bg:Shape = PetsViewAssetFactory.returnPetSlotShape(46, 0x545454, 0, true, false);
