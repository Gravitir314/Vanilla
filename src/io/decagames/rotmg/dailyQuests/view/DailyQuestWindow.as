...
package io.decagames.rotmg.dailyQuests.view
{
    ...
    public class DailyQuestWindow extends Sprite 
    {
        ...
        public function DailyQuestWindow()
        {
            ...
            _local_1.y = 1;
            addChild(_local_1);
            var _local_2:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(32).setColor(0xEAEAEA).setBold(true).setTextWidth(270).setHorizontalAlign(TextAlign.CENTER);
            _local_2.x = 204;
            _local_2.y = 47;
