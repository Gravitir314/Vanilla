...
//io.decagames.rotmg.friends.model.FriendModel
...
package io.decagames.rotmg.friends.model{
    ...
    public class FriendModel {
        ...
        public function get isDataStillLoading():Boolean{
            return ((this._friendsLoadInProcess) || (this._invitationsLoadInProgress));
        }
        ...
        public function ifReachMax():Boolean{
            return (this._friendTotal >= FriendsConfig.MAX_FRIENDS);
        }
        ...
        public function get hasInvitations():Boolean{
            return (this._invitationTotal > 0);
        }
